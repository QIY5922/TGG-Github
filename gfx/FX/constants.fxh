...
static const float3 DayAmbientMapPosZ = float3(0.05, 0.05, 0.1); 
...
static const float WATER_RIPPLE_EFFECT = 0.0023;
...
static const float3 LUMINANCE_VECTOR  			= float3(0.2f, 0.5f, 0.05f);
...
static const float 	FOW_MAX 					= 0.4f; //0.5f
...
static const float  SHADOW_WEIGHT_RIVER   		= 0.3f;
...
static const float BORDER_NIGHT_DESATURATION_MAX = 0.1f; //0.2f
static const float BORDER_FOW_REMOVAL_FACTOR = .8f;
static const float BORDER_LIGHT_REMOVAL_FACTOR = 0.8f;
static const float GB_STRENGTH_CH1 = 1.0;
...
static const float PARTICLE_FADE_START_DISTANCE = 50;
static const float PARTICLE_FADE_STOP_DISTANCE = 250;
